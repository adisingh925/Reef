...
class ApexSingleValueType2Provider_4 : AppWidgetProvider(){
    ...
    override fun onUpdate(
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                val intent = Intent(context, ApexSingleValueType2Provider_4::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexSingleValueType2Provider_4::class.java)
        )
