...
class ApexTwoRectangleWidgetProvider_3 : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if (data.lastIndex >= 2) {
                    views.setTextViewText(R.id.value, data[2].topRectangleValue.toString())
                    views.setTextViewText(R.id.value2, data[2].bottomRectangleValue.toString())

                    views.setTextViewText(R.id.unit, data[2].topRectangleUnit)
                    views.setTextViewText(R.id.unit2, data[2].bottomRectangleUnit)

                    views.setInt(R.id.card2, "setBackgroundColor", data[2].topRectangleColor)
                    views.setInt(R.id.card2, "setBackgroundColor", data[2].bottomRectangleColor)
                } else {
                ...
                val intent = Intent(context, ApexTwoRectangleWidgetProvider_3::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexTwoRectangleWidgetProvider_3::class.java)
        )
