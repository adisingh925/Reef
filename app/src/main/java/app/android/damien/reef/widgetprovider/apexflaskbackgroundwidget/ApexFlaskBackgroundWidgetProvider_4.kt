...
class ApexFlaskBackgroundWidgetProvider_4 : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                val intent = Intent(context, ApexFlaskBackgroundWidgetProvider_4::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexFlaskBackgroundWidgetProvider_4::class.java)
        )
