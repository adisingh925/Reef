...
class ApexGraphWidgetProvider_5 : AppWidgetProvider() {
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    ...
                    if (data.lastIndex >= 4) {
                        val graph = data[4].records?.split(",")?.map { it.toFloat() }
                        ...
                        views.setTextViewText(R.id.unit, data[4].unit)
                    ...
                    val intent = Intent(context, ApexGraphWidgetProvider_5::class.java)
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (intent?.action == Constants.UPDATE_WIDGET_ACTION) {
            ...
            Log.d("ApexGraphWidgetProvider_5", "ApexGraphWidgetProvider_5 tapped")
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexGraphWidgetProvider_5::class.java)
        )
