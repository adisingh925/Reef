...
class Focustronic2RectangleWidget_3 : AppWidgetProvider() {
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if(data.lastIndex < 2){
                    ...
                    views.setInt(R.id.card1, "setBackgroundColor", data[2].topRectangleColor);
                    views.setInt(R.id.card2, "setBackgroundColor", data[2].bottomRectangleColor);
                }

                val intent = Intent(context, Focustronic2RectangleWidget_3::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, Focustronic2RectangleWidget_3::class.java)
        )
