...
class Focustronic2RectangleWidget_2 : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                val intent = Intent(context, Focustronic2RectangleWidget_2::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, Focustronic2RectangleWidget_2::class.java)
        )
