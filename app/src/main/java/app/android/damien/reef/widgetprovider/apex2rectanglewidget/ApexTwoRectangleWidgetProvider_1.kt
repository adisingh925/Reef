...
class ApexTwoRectangleWidgetProvider_1 : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                val intent = Intent(context, ApexTwoRectangleWidgetProvider_1::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexTwoRectangleWidgetProvider_1::class.java)
        )
