...
class FocustronicSingleValueType2_3 : AppWidgetProvider(){
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if(data.lastIndex < 2){
                    ...
                    String.format(Locale.getDefault(), "%.2f",  data[2].value)
                    views.setTextViewText(R.id.value, String.format(Locale.getDefault(), "%.2f",  data[2].value))
                    ...
                    views.setTextColor(R.id.timestamp,  data[2].textColor)
                }

                val intent = Intent(context, FocustronicSingleValueType2_3::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, FocustronicSingleValueType2_3::class.java)
        )
