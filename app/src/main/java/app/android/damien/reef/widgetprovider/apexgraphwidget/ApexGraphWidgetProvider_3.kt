...
class ApexGraphWidgetProvider_3 : AppWidgetProvider() {
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    ...
                    if (data.lastIndex >= 2) {
                        val graph = data[2].records?.split(",")?.map { it.toFloat() }
                        ...
                        views.setTextViewText(R.id.unit, data[2].unit)
                    ...
                    val intent = Intent(context, ApexGraphWidgetProvider_3::class.java)
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (intent?.action == Constants.UPDATE_WIDGET_ACTION) {
            ...
            Log.d("ApexGraphWidgetProvider_3", "ApexGraphWidgetProvider_3 tapped")
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexGraphWidgetProvider_3::class.java)
        )
