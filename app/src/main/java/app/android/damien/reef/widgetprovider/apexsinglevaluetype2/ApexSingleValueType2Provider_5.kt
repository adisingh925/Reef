...
class ApexSingleValueType2Provider_5 : AppWidgetProvider() {
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if(data.lastIndex < 4){
                    ...
                    views.setTextViewText(R.id.value, data[4].value.toString())
                ...
                val intent = Intent(context, ApexSingleValueType2Provider_5::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexSingleValueType2Provider_5::class.java)
        )
