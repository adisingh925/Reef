...
class ApexTwoRectangleWidgetProvider_5 : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if (data.lastIndex >= 4) {
                    views.setTextViewText(R.id.value, data[4].topRectangleValue.toString())
                    views.setTextViewText(R.id.value2, data[4].bottomRectangleValue.toString())

                    views.setTextViewText(R.id.unit, data[4].topRectangleUnit)
                    views.setTextViewText(R.id.unit2, data[4].bottomRectangleUnit)

                    views.setInt(R.id.card2, "setBackgroundColor", data[4].topRectangleColor)
                    views.setInt(R.id.card2, "setBackgroundColor", data[4].bottomRectangleColor)
                } else {
                ...
                val intent = Intent(context, ApexTwoRectangleWidgetProvider_5::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexTwoRectangleWidgetProvider_5::class.java)
        )
