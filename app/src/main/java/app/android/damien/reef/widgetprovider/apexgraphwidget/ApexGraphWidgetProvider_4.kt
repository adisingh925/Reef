...
class ApexGraphWidgetProvider_4 : AppWidgetProvider() {
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    ...
                    if (data.lastIndex >= 3) {
                        val graph = data[3].records?.split(",")?.map { it.toFloat() }
                        ...
                        views.setTextViewText(R.id.unit, data[3].unit)
                    ...
                    val intent = Intent(context, ApexGraphWidgetProvider_4::class.java)
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (intent?.action == Constants.UPDATE_WIDGET_ACTION) {
            ...
            Log.d("ApexGraphWidgetProvider_4", "ApexGraphWidgetProvider_4 tapped")
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexGraphWidgetProvider_4::class.java)
        )
