...
data class CustomWidgetTwoRectangleModel(
    ...
    companion object CREATOR : Parcelable.Creator<CustomWidgetTwoRectangleModel> {
        override fun createFromParcel(parcel: Parcel): CustomWidgetTwoRectangleModel {
            return CustomWidgetTwoRectangleModel(parcel)
        }

        override fun newArray(size: Int): Array<CustomWidgetTwoRectangleModel?> {
