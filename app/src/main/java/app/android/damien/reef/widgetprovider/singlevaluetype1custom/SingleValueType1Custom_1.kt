package app.android.damien.reef.widgetprovider.singlevaluetype1custom
...
class SingleValueType1Custom_1 : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            var data : List<CustomWidgetSingleValueType1Model>
            CoroutineScope(Dispatchers.IO).launch {
                data = Database.getDatabase(context).customWidgetsDao().readCustomSingleValueTypeOneWidgetBackground()
                ...
                val intent = Intent(context, SingleValueType1Custom_1::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, SingleValueType1Custom_1::class.java)
        )
