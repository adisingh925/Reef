...
class ApexPowerValueWidgetProvider_4 : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if(data.lastIndex >= 3){
                    val slot1Value = String.format(Locale.getDefault(), "%.2f", data[3].slot1)
                    val slot2Value = String.format(Locale.getDefault(), "%.2f", data[3].slot2)
                    val slot3Value = String.format(Locale.getDefault(), "%.2f", data[3].slot3)
                ...
                val intent = Intent(context, ApexPowerValueWidgetProvider_4::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, ApexPowerValueWidgetProvider_4::class.java)
        )
