...
class Focustronic2RectangleWidget_5 : AppWidgetProvider() {
        ...
        appWidgetIds?.forEach { appWidgetId ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if(data.lastIndex < 4){
                    ...
                    views.setInt(R.id.card1, "setBackgroundColor", data[4].topRectangleColor);
                    views.setInt(R.id.card2, "setBackgroundColor", data[4].bottomRectangleColor);
                }

                val intent = Intent(context, Focustronic2RectangleWidget_5::class.java)
    ...
    private fun updateWidget(context: Context?) {
        ...
        val appWidgetIds = appWidgetManager.getAppWidgetIds(
            ComponentName(context!!, Focustronic2RectangleWidget_5::class.java)
        )
